...
public class Coverages_Page extends Driver_Page{
	...
	private final static By bygrouplife=ByAngular.buttonText("Group Life");
	private final static By bygroupaccident=ByAngular.buttonText("Group Accident"); 
	private final static By byindividualplan=ByAngular.buttonText("Individual Plans");
