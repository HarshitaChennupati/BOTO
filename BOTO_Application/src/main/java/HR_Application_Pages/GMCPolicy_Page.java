...
public class GMCPolicy_Page extends Driver_Page{
	...
	private final static By bypolicy=ByAngular.buttonText("Policy");
	private final static By byfeatures=ByAngular.buttonText("Features");
	...
	//private final static By byprint=By.cssSelector("button[class='btn btn-custom-bg']");
